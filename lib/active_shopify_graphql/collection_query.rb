...
module ActiveShopifyGraphQL
  ...
  class CollectionQuery
    ...
    def execute(conditions = {}, limit: 250)
      ...
      query = @loader.query_builder.collection_graphql_query(type)
    ...
    def map_response(response_data, type)
      query_name_value = @loader.query_name(type).pluralize
      ...
      nodes.map do |node_data|
        ...
        single_response = { "data" => { @loader.query_name(type) => node_data } }
        @loader.map_response_to_attributes(single_response)
      end.compact
    end
